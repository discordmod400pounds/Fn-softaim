...
def main():
    global RezzyWare
    RezzyWare = Aimbot(collect_data = "collect_data" in sys.argv)
    RezzyWare.start()
...
def setup():
    ...
    print(colored("[INFO] In-game X and Y axis sensitivity should be the same", "blue"))
    def prompt(str):
        valid_input = False
    ...
    with open('lib/config/config.json', 'w') as outfile:
        ...
        print(colored("[INFO] Sensitivity configuration complete", "blue"))
...
|  $$$$$$$    /$$/|   $$  $$_/  | $$  |  $$$$$$$  /$$$$$$/  /$$$$$$/
 ...
 /$$  \ $$  /$$/  |_  $$  $$_/  | $$   /$$  \ $$| $$      | $$      
|  $$$$$$/ /$$/     | $$| $$   /$$$$$$|  $$$$$$/| $$$$$$$$| $$$$$$$$
 \______/ |__/      |__/|__/  |______/ \______/ |________/|________/
    ...
    if not path_exists or ("setup" in sys.argv):
        if not path_exists:
            print(colored("[!] Sensitivity configuration is not set", "blue"))
        setup()
